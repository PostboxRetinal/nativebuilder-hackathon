...
The Speechmatics session token SHALL be obtained from a Supabase Edge Function before connecting. The Speechmatics API key SHALL never be exposed to the browser.
