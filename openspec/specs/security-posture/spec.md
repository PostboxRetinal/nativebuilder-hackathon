...
## Purpose
Frontend security hardening applied during the OWASP Top 10 2021 audit: Content Security Policy, hardened production build, and lint-level injection detection, ensuring the shipped bundle and codebase enforce baseline security controls.
